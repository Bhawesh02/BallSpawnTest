...
public class PlaneView : MonoBehaviour
{
    ...
    private float maxXScale = 16f;
    private float maxYScale = 9.5f;
    ...
    {
        float xscale = Random.Range(1, maxXScale);
        float yscale = Random.Range(1, maxYScale);
        transform.localScale = new(xscale, yscale);
    }
